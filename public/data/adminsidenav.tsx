export const sidenavData = [
  {
    ...
    submenus: [
      { url: "/Dashboard/hotel/all-hotels", title: "All Hotels" },
      { url: "/Dashboard/hotel/add-new-hotel", title: "Add New Hotel" },
      { url: "/Dashboard/hotel/attributes", title: "Attributes" },
      { url: "/Dashboard/hotel/room-attributes", title: "Room Attributes" },
      { url: "/Dashboard/hotel/edit-hotel", title: "Edit Hotel" },
      { url: "/Dashboard/hotel/manage-room", title: "Mange Room" },
    ],
  },
  {
    id: 2,
  ...
  },
  {
    ...
    submenus: [
      { url: "/Dashboard/payment/info", title: "Payment Info" },
      { url: "/Dashboard/payment/gateway", title: "Payment Gateway" },
      { url: "/Dashboard/payment/currencies", title: "Currencies" },
      { url: "/Dashboard/payment/reward", title: "Reward Info" },
      { url: "/Dashboard/payment/promo_code", title: "Promo Code" },
      { url: "/Dashboard/payment/plans", title: "Plans" },
    ],
  },
  {
    id: 18,
