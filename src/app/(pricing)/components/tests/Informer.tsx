...
<button onClick={handleAction} className='border-2 hover:bg-blue-300 border-primary-500 mx-6 px-5 py-3 items-center  jusify-center rounded-full'>Lancer l action</button>
